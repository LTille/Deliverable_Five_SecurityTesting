...
interception, modification and fabrication can exploit this vulnerability. After logging as an administrator, attacker can view application Information and user information (interception);  
transfer funds and change user's password (modification) and add a new user (fabrication).
